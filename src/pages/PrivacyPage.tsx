...
const content = {
  pt: {
    ...
    providers: [
      ...
      "Website Carbon / Wholegrain Digital — estimativa de emissões da página; somente o backend consulta a URL pública, no máximo uma vez a cada 24 horas para todo o site, e preserva centralmente o último resultado válido quando o serviço está indisponível.",
  ...
  en: {
    ...
    providers: [
      ...
      "Website Carbon / Wholegrain Digital — estimating page emissions; only the backend requests the public URL, at most once every 24 hours for the entire site, and centrally preserves the latest valid result while the service is unavailable.",
