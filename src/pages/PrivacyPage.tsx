...
const content = {
  pt: {
    ...
    providers: [
      ...
      "Website Carbon / Wholegrain Digital — estimativa de emissões da página; a consulta envia a URL pública e dados técnicos de conexão, e a nota fica armazenada no navegador por até 7 dias.",
  ...
  en: {
    ...
    providers: [
      ...
      "Website Carbon / Wholegrain Digital — estimating page emissions; the request sends the public URL and technical connection data, and the grade is stored in the browser for up to 7 days.",
