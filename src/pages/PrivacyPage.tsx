...
const content = {
  pt: {
    ...
    providers: [
      ...
      "Website Carbon / Wholegrain Digital — estimativa de emissões da página; a consulta envia a URL pública e dados técnicos de conexão, a nota é revalidada diariamente e a última medição válida pode permanecer armazenada no navegador quando o serviço está indisponível.",
  ...
  en: {
    ...
    providers: [
      ...
      "Website Carbon / Wholegrain Digital — estimating page emissions; the request sends the public URL and technical connection data, the grade is revalidated daily, and the latest valid measurement may remain stored in the browser while the service is unavailable.",
